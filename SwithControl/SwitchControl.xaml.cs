...
namespace cmwGauge.SwitchControl
{
    /// <summary>
    ...
    public partial class SwitchControl : UserControl, INotifyPropertyChanged
    {
        ...
        public SwitchControl()
        {
            ...
            this.switcher.TryAngleChange += new TryAngleChangeHandler(onTryAngleChange);
            this.switcher.PropertyChanged += new PropertyChangedEventHandler(onSwitcherPropertyChanged);
            this.switcher.OriginAngle = this.scale.StartAngle;
        ...
        /// </summary>
        [Description("Occurs when switch change the value.")]
        ...
        public double Value
        {
            get
            {
                return ((this.switcher.Angle / this.scale.AngleRange) * this.scale.Range) + this.scale.Minimum;
            }
            set
            {
                ...
                this.switcher.Angle = (this.Snap) ? snapAngle(newAngle, this.switcher.Angle, false) : newAngle;
            }
        }
        ...
        public double StartAngle
        {
            ...
            set
            {
                this.switcher.OriginAngle = value;
        ...
        {
            get { return this.switcher.PointerFill; }
            set { this.switcher.PointerFill = value; }
        }
        ...
        {
            get { return this.switcher.PointerStroke; }
            set { this.switcher.PointerStroke = value; }
        }
        ...
        {
            double newAngle = Utilities.AngleToPositive360(e.NewAngle);
            ...
            else
            {
                ...
                {
                    this.switcher.Angle = this.scale.AngleRange;
                }
                else
                {
                    this.switcher.Angle = 0;
                }
            }
        }
        ...
        {
            Utilities.MathRoundingMode mathRoundingMode = Math.Round;
            if (isWheelScrolling)
            {
