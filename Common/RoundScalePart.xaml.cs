...
namespace cmwGauge.Common
{
    ...
    internal partial class RoundScalePart : UserControl, IRoundScale
    {
        ...
        {
            get { return Utilities.AngleToPositive360(this.EndAngle - this.StartAngle); }
        }
        ...
        private static object coerceAngleCallback(DependencyObject d, object baseValue)
        {
            ...
            value = Utilities.ReplaceInfinityAndNaN(value);
            return Utilities.AngleToPositive360(value);
        }
        ...
        {
            double value = (double)baseValue;
            return Utilities.ReplaceInfinityAndNaN(value);
        }
        ...
        {
            double angleInRadians = Utilities.DegreeToRadian(angleInDegrees);
